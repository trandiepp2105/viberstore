...
# ==============================================================================
# ORIGIN & ALLOWED HOSTS CONFIGURATION
# ==============================================================================
# FRONTEND_ORIGIN example: http://20.198.225.85
# ADMIN_ORIGIN example: http://20.198.225.85:8088
...
if ADMIN_ORIGIN_CONFIG:
    CSRF_TRUSTED_ORIGINS.append(ADMIN_ORIGIN_CONFIG)
...
if not (EMAIL_HOST_USER and EMAIL_HOST_PASSWORD) and not DEBUG:
...
for vnpay_var in ['VNPAY_RETURN_URL', 'VNPAY_TMN_CODE', 'VNPAY_HASH_SECRET_KEY']:
    if not locals().get(vnpay_var) and not DEBUG:
...
CELERY_BEAT_SCHEDULE = {
    'publish-scheduled-products-job': {
        'task': 'product.tasks.publish_scheduled_products',
...
# ==============================================================================
# ELASTICSEARCH_DSL_URL = os.environ.get('ELASTICSEARCH_URL')
# ELASTICSEARCH_DSL_USER = os.environ.get('ELASTIC_USERNAME')
# ELASTICSEARCH_DSL_PASS = os.environ.get('ELASTIC_PASSWORD')

# ELASTICSEARCH_DSL = {
#     'default': {
#         'hosts': ELASTICSEARCH_DSL_URL if ELASTICSEARCH_DSL_URL else 'http://localhost:9200',
