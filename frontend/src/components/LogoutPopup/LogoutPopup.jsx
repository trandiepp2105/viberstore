...
const LogoutPopup = ({ handleClose, handleLogout }) => {
  return (
      ...
      <div className="popup">
        ...
        <div className="popup-main">
          <img
            ...
            alt=""
            className="logout-popup-bg"
          />
          <h4 className="popup-title">Exit account</h4>
          <p className="popup-description">
            You will not receive member-only privileges.
          </p>
        </div>
